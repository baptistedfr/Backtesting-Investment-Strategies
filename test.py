...
strategy = RandomFluctuationStrategy(rebalance_frequency=FrequencyType.MONTHLY)
...
# strategy2 = RandomFluctuationStrategy(FrequencyType.WEEKLY)
...
results_random.ptf_drawdown_plot.show()